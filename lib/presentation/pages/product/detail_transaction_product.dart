...
class DetailTransactionProduct extends StatefulWidget {
  const DetailTransactionProduct({super.key, required this.trxId});
  final int trxId;
...
class _DetailTransactionProductState extends State<DetailTransactionProduct> {
  ...
  Widget build(BuildContext context) {
    ...
    void showPaymentCodeDialog(
      BuildContext context,
      WinpayResponseProduct data,
    ) {
      showDialog(
        context: context,
        builder: (_) {
  ...
  Widget _buildCardLacak() {
    return GestureDetector(
      onTap: () => context.push('/tracking-product', extra: widget.trxId),
      child: Container(
